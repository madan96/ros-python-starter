# ROS Python Starter Repo

![workflow](https://github.com/tomsilver/python-starter/actions/workflows/ci.yml/badge.svg)

A basic template (based on [Python Starter](https://github.com/tomsilver/python-research-starter)) for building Python packages.
...
### Set Up the Code
2. **Clone this repository** into the `src` folder for your ROS workspace and give it the name of your repo: `git clone git@github.com:tomsilver/python-starter.git <NAME>`. You now have a directory called NAME. **Enter** it: `cd <NAME>`.
